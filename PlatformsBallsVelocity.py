...
A big challenge was to make a child class of two different parents classes.
In the
def__init__(self, all arguments from Class1 , Class2, etc..,Classn, and the new args of this specific child)

    Class1.__init__(self, args Class1)
    Class2.__init__(self,args Class2)
    .
    .
    .
    Classn.__init__(self,args Classn)
    self.arg1_child = arg1_child
    self.arg2_child = arg2_child

Class with two different parents Ball and Platoblique

class Arrow(Platoblique, Ball):
    def __init__(self, x, y, l, w, color, incline, direction, arrowsize):
        Platoblique.__init__(self, x, y, l, w, color, incline)
        Ball.__init__(self)
        self.x = x
        self.y = y
        self.l = l
        ...
        pygame.draw.polygon(self.image, color,
                            ((20, 51), (80, 51), (80, 54), (85, 50), (80, 46), (80, 49), (20, 49)), 0)
        self.image_orig = self.image.convert_alpha()
        self.image = pygame.transform.rotozoom(self.image_orig, direction, arrowsize)
...
class Ball(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.x = 25
        self.y = 25
        self.image = pygame.Surface((50, 53))
        self.image.set_colorkey(BLACK)  # black transparent
        pygame.draw.circle(self.image, GREEN, (25, 25), int(self.BALL_SIZE / 2), 2)  # red circle
        ...
        # using a arrow size prop to the speed
        ...
        for p in plat_list:
            for bally in ball_list:
                ...
                if bally == pygame.sprite.spritecollideany(p, ball_list, collided=None):
                    bally.pos[0] = bally.pos[0] - 2
                    bally.pos[1] = bally.pos[1] - 2
